...
from organic_agentic_autodev.mouseion.contracts import EventEnvelopeV0, EventKind
...
class SLITracker:
    ...
    def _measure_consensus_rate(self) -> SLIMeasurementV0:
        ...
        """
        from organic_agentic_autodev.domain.exmorbus.seeder import EXMORBUS_SEED_AUTHOR
        oncology_records = [
            r for r in self._mouseion.all_knowledge()
    ...
    def _emit_breach_event(self, evaluation: SLOEvaluationV0) -> None:
        ...
        from organic_agentic_autodev.slime_mold.signal import SignalType
