...
Usage:
    python -m organic_agentic_autodev.cognition.run_cycle --seed seed.json --out artifacts.jsonl
    python -m organic_agentic_autodev.cognition.run_cycle --seed seed.json --out artifacts.jsonl --model claude-sonnet-4-6
...
from organic_agentic_autodev.cognition.bridge import LearningCycle, make_cognition
